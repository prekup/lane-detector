...
3. Iterative weighted least square regression was used to fit lane lines, to calculate the vanishing point according to the lane lines, to iteratively refine the lane positions and to detect outliers.
